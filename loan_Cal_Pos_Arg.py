...
if args.type == 'annuity':
    if args.periods == None:
        ...
        print(f'Total payment= {loan_principal + (annuity_monthly_payment * total_months - loan_principal)}')
        ...
        print(f'Total payment= {loan_principal + round(math.ceil(annuity_monthly_payment) * n_monthly_payments - loan_principal)}')
        ...
        print(f'Total payment= {math.floor(loan_principal) + math.ceil(annuity_monthly_payment * n_monthly_payments - loan_principal)}')
elif args.type == 'diff':
